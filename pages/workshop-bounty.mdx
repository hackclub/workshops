...
- You must be a club leader an active community member in order to submit a workshop
...
- Your workshop must include 3 specific ways people can make their own version of the project using the concepts they learned in the workshop. Can list 3 projects people in your club meeting made or simply list 3 hypothetical hacks.
...
- Your workshop must be written in Markdown or another format that can easily be added to the [Workshops page](https://workshops.hackclub.com). We will not accept PDFs, a Google Docs link, etc.
- Each step in your workshop should be explained as clearly as possible, and should always stay in context.
...
Every workshop we accept as part of the workshop bounty program should be something we're proud to stand by as official Hack Club curriculum. If any of the above requirements are not hit, we will ask you to resubmit once you've met all guidelines. If this is your first time submitting a workshop, it is likely your submission will be rejected multiple times before it's ready to merge. Writing a good workshop is very challenging, and although we are a very small team and we can't promise that we'll be able to provide detailed editing and feedback on submissions, we will work with you to get your workshop ready to merge.
