...
- All assets (images, PDFs, and any other binaries) must be hosted using the `#cdn` channel on the Hack Club Slack for posterity and to cut down on repository size
