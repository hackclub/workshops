...
- Help club members produce a compelling and real project with code in under 20 minutes
...
- Use [repl.it](https://repl.it/) or a similar service that allows members to begin coding online with one click (since many club members are using Chromebooks or iPads without desktop software)
...
Please note: the meeting where you test your workshop can be a real club meeting or a mock meeting where you gather 3+ friends.
...
- All assets (images, PDFs, and any other binaries) must be hosted using the `#cdn` channel on the Hack Club Slack for posterity and to cut down on repository size. Images must include [alt text](https://webaim.org/techniques/alttext/) ([Markdown guide](https://daringfireball.net/projects/markdown/syntax#img)). Code snippets should be included in text (not as screenshots) and preferably [syntax-highlighted](https://docs.github.com/en/github/writing-on-github/creating-and-highlighting-code-blocks#syntax-highlighting).
- All workshops must involve code, and not require desktop software or hardware, since not all clubs will have those resources
...
- Create a pull request to [`hackclub/hackclub`](https://github.com/hackclub/hackclub) on GitHub with a new folder in the [`workshops/`](https://github.com/hackclub/hackclub/tree/main/workshops) directory. Put your workshop in a file named `README.md`.
  ...
  - At the top of the file, include the following metadata (author being your GitHub @username):
    ...
    img: 'link-to-image-summarizing-your-workshop'
    ---
    ```
  - In your pull request, include the club you lead and/or your Slack username
