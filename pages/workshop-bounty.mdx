...
author={{
  name: '@zrl',
  avatar: 'https://cdn.hackclub.com/rescue?url=https://cloud-c8m8jr772.vercel.app/image.png',
  url: 'https://zachlatta.com'
}}
date="2020-09-09"
path="workshop-bounty.mdx">

_FYI: The Workshop Bounty program has now ended, thank you to everyone who contributed a workshop (or more)!_
...
This semester, if you contribute a workshop to [workshops.hackclub.com](https://workshops.hackclub.com), **we'll pay you $200**. You could write workshops instead of a part-time job for personal income. Or you could write workshops to fundraise for your club.
...
[Sound Galaxy](https://workshops.hackclub.com/sound_galaxy/) is an example of a good workshop. It's short, produces a visual project, and has clear paths to keep experimenting. Hear <StaticMention username="matthew" avatar="https://cdn.hackclub.com/rescue?url=https://cloud-dl8z4zly8.vercel.app/t0266frgm-u4qak9srw-cf4e2e522a71-512" link="https://matthewstanciu.me/" />'s thoughts:

<Video
  mux="pf0227X6ni00uCWWPBdJqiQTVkSuqzg7cWw00s91Nr9pK8"
  autoPlay={false}
  style={{ maxWidth: '100%' }}
/>

In the past, Hack Club workshops were all Markdown files formatted like blog posts. We want to push the format and will be accepting interactive [MDX](https://github.com/mdx-js/mdx) files, slideshows, static websites, and more (regular Markdown is still OK!).

**Submission requirements:**

_Updated by <StaticMention username="matthew" avatar="https://cdn.hackclub.com/rescue?url=https://cloud-dl8z4zly8.vercel.app/t0266frgm-u4qak9srw-cf4e2e522a71-512" link="https://matthewstanciu.me/" /> on 10/29/2020. Starting today, all newly-submitted workshops will have to follow these new requirements. [Click here](https://hack.af/workshop-bounty-original) to see the previous version of this announcement._
