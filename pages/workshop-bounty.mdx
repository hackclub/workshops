...
- Your workshop must produce a compelling, specific, real project. **It should *not* be a tutorial** for a language or service. It should also not be a series of small projects with no clear ending or final product.
  <details>
  <summary>Examples</summary>
  	- ✅ a workshop that makes a game about finding Bigfoot using JavaScript
	- ❌ a tutorial for how to get started with AWS
  <details>
- Your workshop must be able to be completed in around 20 minutes.
- Your workshop must use [repl.it](https://repl.it) or a similar service that allows you to code online. People who go through the workshop should not be expected to download software or use hardware.
- Your workshop must include 3 specific ways people can make it into their own project using the concepts they learned in the workshop
	- ✅ [splatter paint](https://workshops.hackclub.com/splatter_paint/), which includes 3 projects at the end that stem from the project made in the workshop but are very noticeably different and clearly made independently
