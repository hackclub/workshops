...
*Updated by <StaticMention username="matthew" avatar="https://cloud-dl8z4zly8.vercel.app/t0266frgm-u4qak9srw-cf4e2e522a71-512" link="https://matthewstanciu.me/" /> on 10/29/2020. Starting today, all newly-submitted workshops will have to follow these new requirements. [Click here](https://hack.af/workshop-bounty-original) to see the previous version of this announcement.*
...
- Every piece of media (image, GIF, video, etc.) you include in your workshop should include alt text that clearly describes what's in the piece of media
  - ✅ `![A close-up of a gecko foot being pressed on glass](https://cloud-dng5gwsrk.vercel.app/0image_from_ios.jpg)`
  - ❌ `![](https://cloud-dng5gwsrk.vercel.app/0image_from_ios.jpg)`
  - ❌ `![animal](https://cloud-dng5gwsrk.vercel.app/0image_from_ios.jpg)`
...
Every workshop we accept as part of the workshop bounty program should be something we're proud to stand by as official Hack Club curriculum. If any of the above requirements are not hit, we will ask you to resubmit once you've met all guidelines. If this is your first time submitting a workshop, it is likely your submission will be rejected multiple times before it's ready to merge. Writing a good workshop is very challenging, and although we are a very small team and we can't promise that we'll be able to provide detailed editing and feedback on submissions, we will work with you to get your workshop in a good spot.
